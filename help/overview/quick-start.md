...
* De capaciteit om optimalisaties op te stellen is beschikbaar in Vroege Toegang. Leer meer bij [&#x200B; optimaliseren bij Edge vaak Gestelde Vragen &#x200B;](https://experienceleague.adobe.com/nl/docs/llm-optimizer/using/resources/optimize-at-edge#frequently-asked-questions).
