...
Deze genormaliseerde velden worden weergegeven via de hoekweergave. Op het [&#128279;](/help/dashboards/referral-traffic.md) dashboard van het Verkeer van 0&rbrace; Referral &lbrace;, worden de logboeken CDN gebruikt om de metriek van de paginascheiding te tonen. Er wordt geen persoonlijk identificeerbare informatie (PII) verwerkt of opgeslagen in een stadium van CDN-logopname of daaropvolgende gegevensverwerking.
